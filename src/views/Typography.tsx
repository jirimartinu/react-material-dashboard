...
import { Grid, Typography as MuiTypography, Theme, withStyles, WithStyles } from '@material-ui/core';
...
class Typography extends React.PureComponent<WithStyles<typeof styles>> {
  public render() {
    return (
          ...
          {Object.keys(variants).map((key, i) => (
            <Fragment key={i}>
              ...
              <Grid
                ...
                xs={12}
              >
                <MuiTypography variant={(key as any)}>{variants[key]}</MuiTypography>
              </Grid>
            </Fragment>
          ))}
        </Grid>
